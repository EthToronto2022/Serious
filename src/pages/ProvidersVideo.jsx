...
const getRecordingUrl = async () => {
    const response = await axios.get("https://livepeer.studio/api/stream/4ad44e95-fa1c-44c1-bf8d-669d67bd7d1a/sessions?record=1", { 
      headers: {
      ...
      <main className="grow">
        <div className="flex justify-center items-center mt-72 flex-col">
          ...
          <p className="mb-12 text-lg">
            Record personalized video for prospects who have committed to watch it. 
          </p>
          ...
          <br />
          <p><a href={recordingUrl} target="_blank">{recordingUrl}</a></p>
